...
// JFParseFBFriends
#define COCOAPODS_POD_AVAILABLE_JFParseFBFriends
#define COCOAPODS_VERSION_MAJOR_JFParseFBFriends 1
#define COCOAPODS_VERSION_MINOR_JFParseFBFriends 0
#define COCOAPODS_VERSION_PATCH_JFParseFBFriends 0
